...
#include "MadgwickOriginal.h"
#include "logger.h"

#include <math.h>

//// System constants
#define DELTAT 0.024f // sampling period in seconds (shown as 1 ms)
#define gyroMeasError 3.14159265358979 * (10.0f / 180.0f) // gyroscope measurement error in rad/s (shown as 5 deg/s)
#define gyroMeasDrift 3.14159265358979 * (0.1f / 180.0f) // gyroscope measurement error in rad/s/s (shown as 0.2f deg/s/s)
